...
class SparseBatch(ctypes.Structure):
    ...
    def get_tensors(self, device):
        ...
        bucket = torch.from_numpy(np.ctypeslib.as_array(self.bucket, shape=(self.size,))).pin_memory().to(device=device, non_blocking=True).long()
        return us, them, white, black, outcome, score, ply, bucket
